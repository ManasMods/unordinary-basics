...
public class ClientUtils {
    ...
    private void renderPiece(BedBlockEntity entity, PoseStack pPoseStack, MultiBufferSource pBufferSource, ModelPart pModelPart, Direction pDirection, Material pMaterial, int pPackedLight,
        ...
        if (entity != null && entity instanceof IPatternable) {
            ...
            if (pattern.getPatterns().size() > 0) {
                ...
                if (entity != null && entity instanceof IColorable color) {
