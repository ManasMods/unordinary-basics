...
class BlockEntityRegistry {
    ...
    public static void register(DeferredRegister<BlockEntityType<?>> registry) {
        ...
        registry.register("prismarine_smoker_block_entity", () -> BlockEntityType.Builder.of(PrismarineSmokerBlockEntity::new, Unordinary_BasicsBlocks.PRISMARINE_SMOKER).build(null));
    }
}
