...
public class GrassSproutableSlabBlock extends SlabBlock {

    public final Block blockTypeGrass;
    public final Block blockTypeMycelium;
    public GrassSproutableSlabBlock(Properties pProperties, Block pBlockTypeMycelium, Block pBlockTypeGrass) {
        super(pProperties);
