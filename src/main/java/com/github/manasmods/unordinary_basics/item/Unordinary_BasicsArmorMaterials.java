...
public enum Unordinary_BasicsArmorMaterials implements ArmorMaterial {
    RABBIT("rabbit", 6, new int[]{1, 2, 3, 1},new int[]{13, 15, 16, 11}, 15, SoundEvents.ARMOR_EQUIP_LEATHER, 0.0F, 0.0F, () -> Ingredient.of(Items.RABBIT_HIDE)),
    TECHNOBLADE_CROWN("technoblade_crown", 37, new int[]{3, 6, 8, 3},new int[]{1, 3, 5, 2}, 25, SoundEvents.ARMOR_EQUIP_GOLD, 3.0F, 0.2F, () -> Ingredient.of(Items.GOLD_BLOCK));
