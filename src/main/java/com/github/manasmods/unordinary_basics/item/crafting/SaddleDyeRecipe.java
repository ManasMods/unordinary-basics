package com.github.manasmods.unordinary_basics.item.crafting;
...
public class SaddleDyeRecipe extends CustomRecipe {

    public SaddleDyeRecipe(ResourceLocation p_43757_) {
        super(p_43757_);
    }
