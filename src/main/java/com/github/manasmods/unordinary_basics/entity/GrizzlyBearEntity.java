...
public class GrizzlyBearEntity extends TamableAnimal implements NeutralMob {
    private static final EntityDataAccessor<Boolean> DATA_STANDING_ID = SynchedEntityData.defineId(GrizzlyBearEntity.class, EntityDataSerializers.BOOLEAN);
    ...
    public GrizzlyBearEntity(EntityType<? extends TamableAnimal> pType, Level pLevel) {
        super(pType, pLevel);
    }
    protected void registerGoals() {
        super.registerGoals();
        this.goalSelector.addGoal(0, new FloatGoal(this));
        this.goalSelector.addGoal(1, new GrizzlyBearEntity.GrizzlyBearEntityMeleeAttackGoal());
        this.goalSelector.addGoal(2, new SitWhenOrderedToGoal(this));
        this.goalSelector.addGoal(2, new FollowOwnerGoal(this, 1.0D, 10.0F, 2.0F, true));
        this.goalSelector.addGoal(3, new GrizzlyBearEntity.GrizzlyBearEntityPanicGoal());this.goalSelector.addGoal(4, new FollowParentGoal(this, 1.25D));this.targetSelector.addGoal(3, new NearestAttackableTargetGoal<>(this, Player.class, 10, true, false, this::isAngryAt));this.targetSelector.addGoal(4, new NearestAttackableTargetGoal<>(this, Fox.class, 10, true, true, (Predicate<LivingEntity>)null));
        this.goalSelector.addGoal(5, new RandomStrollGoal(this, 1.0D));
        this.goalSelector.addGoal(6, new LookAtPlayerGoal(this, Player.class, 6.0F));
        this.goalSelector.addGoal(7, new BreedGoal(this, 1.0D));
        this.goalSelector.addGoal(7, new RandomLookAroundGoal(this));
        this.targetSelector.addGoal(1, new GrizzlyBearEntity.GrizzlyBearEntityHurtByTargetGoal());
        this.targetSelector.addGoal(2, new GrizzlyBearEntity.GrizzlyBearEntityAttackPlayersGoal());
    ...
    /*public static boolean checkGrizzlyBearEntitySpawnRules(EntityType<GrizzlyBearEntity> p_29550_, LevelAccessor p_29551_, MobSpawnType p_29552_, BlockPos p_29553_, Random random) {
        ...
        if (holder.is(Biomes.PLAINS) || holder.is(Biomes.FOREST) ||
            ...
            return checkAnimalSpawnRules(p_29550_, p_29551_, p_29552_, p_29553_, random);
        }
        return false;
    }*/
    ...
    public AgeableMob getBreedOffspring(ServerLevel pLevel, AgeableMob p_146744_) {
        GrizzlyBearEntity bear = UBEntityTypes.GRIZZLY_BEAR.get().create(pLevel);
    ...
    @Override
    public boolean isFood(ItemStack stack) {return stack.is(Items.HONEYCOMB);}
    @Override
    ...
    class GrizzlyBearEntityAttackPlayersGoal extends NearestAttackableTargetGoal<Player> {
        public GrizzlyBearEntityAttackPlayersGoal() {
            super(GrizzlyBearEntity.this, Player.class, 20, true, true, (Predicate<LivingEntity>)null);
        }
    ...
    class GrizzlyBearEntityHurtByTargetGoal extends HurtByTargetGoal {
        public GrizzlyBearEntityHurtByTargetGoal() {
        ...
        protected void alertOther(Mob pMob, LivingEntity pTarget) {
            if (pMob instanceof GrizzlyBearEntity && !pMob.isBaby()) {
    ...
    class GrizzlyBearEntityMeleeAttackGoal extends MeleeAttackGoal {
        public GrizzlyBearEntityMeleeAttackGoal() {
    ...
    class GrizzlyBearEntityPanicGoal extends PanicGoal {
        public GrizzlyBearEntityPanicGoal() {
