...
public class BlockRegistry {
    ...
    private static void registerBlocks(DeferredRegister<Block> registry) {
        ...
        registry.register("glass_stairs", () -> new StairBlock(Blocks.GLASS::defaultBlockState, (BlockBehaviour.Properties.copy(Blocks.GLASS).noOcclusion()).requiresCorrectToolForDrops()));
        registry.register("tinted_glass_stairs", () -> new StairBlock(Blocks.TINTED_GLASS::defaultBlockState, (BlockBehaviour.Properties.copy(Blocks.TINTED_GLASS).noOcclusion()).requiresCorrectToolForDrops()));
        ...
        registry.register("white_stained_glass_stairs", () -> new StairBlock(Blocks.WHITE_STAINED_GLASS::defaultBlockState, (BlockBehaviour.Properties.copy(Blocks.WHITE_STAINED_GLASS).noOcclusion()).requiresCorrectToolForDrops()));
        registry.register("orange_stained_glass_stairs", () -> new StairBlock(Blocks.ORANGE_STAINED_GLASS::defaultBlockState, (BlockBehaviour.Properties.copy(Blocks.ORANGE_STAINED_GLASS).noOcclusion()).requiresCorrectToolForDrops()));
        registry.register("magenta_stained_glass_stairs", () -> new StairBlock(Blocks.MAGENTA_STAINED_GLASS::defaultBlockState, (BlockBehaviour.Properties.copy(Blocks.MAGENTA_STAINED_GLASS).noOcclusion()).requiresCorrectToolForDrops()));
        registry.register("light_blue_stained_glass_stairs", () -> new StairBlock(Blocks.LIGHT_BLUE_STAINED_GLASS::defaultBlockState, (BlockBehaviour.Properties.copy(Blocks.LIGHT_BLUE_STAINED_GLASS).noOcclusion()).requiresCorrectToolForDrops()));
        registry.register("yellow_stained_glass_stairs", () -> new StairBlock(Blocks.YELLOW_STAINED_GLASS::defaultBlockState, (BlockBehaviour.Properties.copy(Blocks.YELLOW_STAINED_GLASS).noOcclusion()).requiresCorrectToolForDrops()));
        registry.register("lime_stained_glass_stairs", () -> new StairBlock(Blocks.LIME_STAINED_GLASS::defaultBlockState, (BlockBehaviour.Properties.copy(Blocks.LIME_STAINED_GLASS).noOcclusion()).requiresCorrectToolForDrops()));
        registry.register("pink_stained_glass_stairs", () -> new StairBlock(Blocks.PINK_STAINED_GLASS::defaultBlockState, (BlockBehaviour.Properties.copy(Blocks.PINK_STAINED_GLASS).noOcclusion()).requiresCorrectToolForDrops()));
        registry.register("gray_stained_glass_stairs", () -> new StairBlock(Blocks.GRAY_STAINED_GLASS::defaultBlockState, (BlockBehaviour.Properties.copy(Blocks.GRAY_STAINED_GLASS).noOcclusion()).requiresCorrectToolForDrops()));
        registry.register("light_gray_stained_glass_stairs", () -> new StairBlock(Blocks.LIGHT_GRAY_STAINED_GLASS::defaultBlockState, (BlockBehaviour.Properties.copy(Blocks.LIGHT_GRAY_STAINED_GLASS).noOcclusion()).requiresCorrectToolForDrops()));
        registry.register("cyan_stained_glass_stairs", () -> new StairBlock(Blocks.CYAN_STAINED_GLASS::defaultBlockState, (BlockBehaviour.Properties.copy(Blocks.CYAN_STAINED_GLASS).noOcclusion()).requiresCorrectToolForDrops()));
        registry.register("purple_stained_glass_stairs", () -> new StairBlock(Blocks.PURPLE_STAINED_GLASS::defaultBlockState, (BlockBehaviour.Properties.copy(Blocks.PURPLE_STAINED_GLASS).noOcclusion()).requiresCorrectToolForDrops()));
        registry.register("blue_stained_glass_stairs", () -> new StairBlock(Blocks.BLUE_STAINED_GLASS::defaultBlockState, (BlockBehaviour.Properties.copy(Blocks.BLUE_STAINED_GLASS).noOcclusion()).requiresCorrectToolForDrops()));
        registry.register("brown_stained_glass_stairs", () -> new StairBlock(Blocks.BROWN_STAINED_GLASS::defaultBlockState, (BlockBehaviour.Properties.copy(Blocks.BROWN_STAINED_GLASS).noOcclusion()).requiresCorrectToolForDrops()));
        registry.register("green_stained_glass_stairs", () -> new StairBlock(Blocks.GREEN_STAINED_GLASS::defaultBlockState, (BlockBehaviour.Properties.copy(Blocks.GREEN_STAINED_GLASS).noOcclusion()).requiresCorrectToolForDrops()));
        registry.register("red_stained_glass_stairs", () -> new StairBlock(Blocks.RED_STAINED_GLASS::defaultBlockState, (BlockBehaviour.Properties.copy(Blocks.RED_STAINED_GLASS).noOcclusion()).requiresCorrectToolForDrops()));
        registry.register("black_stained_glass_stairs", () -> new StairBlock(Blocks.BLACK_STAINED_GLASS::defaultBlockState, (BlockBehaviour.Properties.copy(Blocks.BLACK_STAINED_GLASS).noOcclusion()).requiresCorrectToolForDrops()));
        ...
        registry.register("glass_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Blocks.GLASS).noOcclusion().requiresCorrectToolForDrops()));
        registry.register("tinted_glass_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Blocks.TINTED_GLASS).noOcclusion().requiresCorrectToolForDrops()));
        ...
        registry.register("white_stained_glass_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Blocks.WHITE_STAINED_GLASS).noOcclusion().requiresCorrectToolForDrops()));
        registry.register("orange_stained_glass_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Blocks.ORANGE_STAINED_GLASS).noOcclusion().requiresCorrectToolForDrops()));
        registry.register("magenta_stained_glass_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Blocks.MAGENTA_STAINED_GLASS).noOcclusion().requiresCorrectToolForDrops()));
        registry.register("light_blue_stained_glass_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Blocks.LIGHT_BLUE_STAINED_GLASS).noOcclusion().requiresCorrectToolForDrops()));
        registry.register("yellow_stained_glass_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Blocks.YELLOW_STAINED_GLASS).noOcclusion().requiresCorrectToolForDrops()));
        registry.register("lime_stained_glass_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Blocks.LIME_STAINED_GLASS).noOcclusion().requiresCorrectToolForDrops()));
        registry.register("pink_stained_glass_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Blocks.PINK_STAINED_GLASS).noOcclusion().requiresCorrectToolForDrops()));
        registry.register("gray_stained_glass_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Blocks.GRAY_STAINED_GLASS).noOcclusion().requiresCorrectToolForDrops()));
        registry.register("light_gray_stained_glass_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Blocks.LIGHT_GRAY_STAINED_GLASS).noOcclusion().requiresCorrectToolForDrops()));
        registry.register("cyan_stained_glass_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Blocks.CYAN_STAINED_GLASS).noOcclusion().requiresCorrectToolForDrops()));
        registry.register("purple_stained_glass_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Blocks.PURPLE_STAINED_GLASS).noOcclusion().requiresCorrectToolForDrops()));
        registry.register("blue_stained_glass_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Blocks.BLUE_STAINED_GLASS).noOcclusion().requiresCorrectToolForDrops()));
        registry.register("brown_stained_glass_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Blocks.BROWN_STAINED_GLASS).noOcclusion().requiresCorrectToolForDrops()));
        registry.register("green_stained_glass_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Blocks.GREEN_STAINED_GLASS).noOcclusion().requiresCorrectToolForDrops()));
        registry.register("red_stained_glass_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Blocks.RED_STAINED_GLASS).noOcclusion().requiresCorrectToolForDrops()));
        registry.register("black_stained_glass_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Blocks.BLACK_STAINED_GLASS).noOcclusion().requiresCorrectToolForDrops()));
    ...
    static void registerItems(DeferredRegister<Item> registry) {
        ...
        registry.register("oak_log", () -> new BlockItem(Vanilla_PlusBlocks.OAK_LOG, new Item.Properties()));
        registry.register("birch_log", () -> new BlockItem(Vanilla_PlusBlocks.BIRCH_LOG, new Item.Properties()));
        registry.register("spruce_log", () -> new BlockItem(Vanilla_PlusBlocks.SPRUCE_LOG, new Item.Properties()));
        registry.register("acacia_log", () -> new BlockItem(Vanilla_PlusBlocks.ACACIA_LOG, new Item.Properties()));
        registry.register("dark_oak_log", () -> new BlockItem(Vanilla_PlusBlocks.DARK_OAK_LOG, new Item.Properties()));
        registry.register("jungle_log", () -> new BlockItem(Vanilla_PlusBlocks.JUNGLE_LOG, new Item.Properties()));
        registry.register("warped_stem", () -> new BlockItem(Vanilla_PlusBlocks.WARPED_STEM, new Item.Properties()));
        registry.register("crimson_stem", () -> new BlockItem(Vanilla_PlusBlocks.CRIMSON_STEM, new Item.Properties()));
        registry.register("stripped_oak_log", () -> new BlockItem(Vanilla_PlusBlocks.STRIPPED_OAK_LOG, new Item.Properties()));
        registry.register("stripped_birch_log", () -> new BlockItem(Vanilla_PlusBlocks.STRIPPED_BIRCH_LOG, new Item.Properties()));
        registry.register("stripped_spruce_log", () -> new BlockItem(Vanilla_PlusBlocks.STRIPPED_SPRUCE_LOG, new Item.Properties()));
        registry.register("stripped_acacia_log", () -> new BlockItem(Vanilla_PlusBlocks.STRIPPED_ACACIA_LOG, new Item.Properties()));
        registry.register("stripped_dark_oak_log", () -> new BlockItem(Vanilla_PlusBlocks.STRIPPED_DARK_OAK_LOG, new Item.Properties()));
        registry.register("stripped_jungle_log", () -> new BlockItem(Vanilla_PlusBlocks.STRIPPED_JUNGLE_LOG, new Item.Properties()));
        registry.register("stripped_warped_stem", () -> new BlockItem(Vanilla_PlusBlocks.STRIPPED_WARPED_STEM, new Item.Properties()));
        registry.register("stripped_crimson_stem", () -> new BlockItem(Vanilla_PlusBlocks.STRIPPED_CRIMSON_STEM, new Item.Properties()));
        registry.register("purpur_pillar", () -> new BlockItem(Vanilla_PlusBlocks.PURPUR_PILLAR, new Item.Properties()));
        registry.register("quartz_pillar", () -> new BlockItem(Vanilla_PlusBlocks.QUARTZ_PILLAR, new Item.Properties()));
        registry.register("hay_block", () -> new BlockItem(Vanilla_PlusBlocks.HAY_BLOCK, new Item.Properties()));
    }
