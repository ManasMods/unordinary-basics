...
public class FletchingTableRecipe implements Recipe<SimpleContainer> {
    ...
    public FletchingTableRecipe(ResourceLocation id, ItemStack output,
    ...
    public static class Serializer implements RecipeSerializer<FletchingTableRecipe> {
        ...
        public static final ResourceLocation ID = new ResourceLocation(Vanilla_Plus.MOD_ID,"fletching");

        @Override
        public FletchingTableRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new FletchingTableRecipe(id, output, inputs);
        }

        @Override
        public FletchingTableRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buf, FletchingTableRecipe recipe) {
