...
public class BlockRegistry {
    ...
    private static void registerBlocks(DeferredRegister<Block> registry) {
        ...
        registry.register("oak_log_stairs", () -> new StairBlock(Vanilla_PlusBlocks.OAK_LOG::defaultBlockState, (BlockBehaviour.Properties.copy(Vanilla_PlusBlocks.OAK_LOG))));
        registry.register("spruce_log_stairs", () -> new StairBlock(Vanilla_PlusBlocks.SPRUCE_LOG::defaultBlockState, (BlockBehaviour.Properties.copy(Vanilla_PlusBlocks.SPRUCE_LOG))));
        registry.register("birch_log_stairs", () -> new StairBlock(Vanilla_PlusBlocks.BIRCH_LOG::defaultBlockState, (BlockBehaviour.Properties.copy(Vanilla_PlusBlocks.BIRCH_LOG))));
        registry.register("jungle_log_stairs", () -> new StairBlock(Vanilla_PlusBlocks.JUNGLE_LOG::defaultBlockState, (BlockBehaviour.Properties.copy(Vanilla_PlusBlocks.JUNGLE_LOG))));
        registry.register("acacia_log_stairs", () -> new StairBlock(Vanilla_PlusBlocks.ACACIA_LOG::defaultBlockState, (BlockBehaviour.Properties.copy(Vanilla_PlusBlocks.ACACIA_LOG))));
        registry.register("dark_oak_log_stairs", () -> new StairBlock(Vanilla_PlusBlocks.DARK_OAK_LOG::defaultBlockState, (BlockBehaviour.Properties.copy(Vanilla_PlusBlocks.DARK_OAK_LOG))));
        registry.register("crimson_stem_stairs", () -> new StairBlock(Vanilla_PlusBlocks.CRIMSON_STEM::defaultBlockState, (BlockBehaviour.Properties.copy(Vanilla_PlusBlocks.CRIMSON_STEM))));
        registry.register("warped_stem_stairs", () -> new StairBlock(Vanilla_PlusBlocks.WARPED_STEM::defaultBlockState, (BlockBehaviour.Properties.copy(Vanilla_PlusBlocks.WARPED_STEM))));
        registry.register("stripped_oak_log_stairs", () -> new StairBlock(Vanilla_PlusBlocks.STRIPPED_OAK_LOG::defaultBlockState, (BlockBehaviour.Properties.copy(Vanilla_PlusBlocks.STRIPPED_OAK_LOG))));
        registry.register("stripped_spruce_log_stairs", () -> new StairBlock(Vanilla_PlusBlocks.STRIPPED_SPRUCE_LOG::defaultBlockState, (BlockBehaviour.Properties.copy(Vanilla_PlusBlocks.STRIPPED_SPRUCE_LOG))));
        registry.register("stripped_birch_log_stairs", () -> new StairBlock(Vanilla_PlusBlocks.STRIPPED_BIRCH_LOG::defaultBlockState, (BlockBehaviour.Properties.copy(Vanilla_PlusBlocks.STRIPPED_BIRCH_LOG))));
        registry.register("stripped_jungle_log_stairs", () -> new StairBlock(Vanilla_PlusBlocks.STRIPPED_JUNGLE_LOG::defaultBlockState, (BlockBehaviour.Properties.copy(Vanilla_PlusBlocks.STRIPPED_JUNGLE_LOG))));
        registry.register("stripped_acacia_log_stairs", () -> new StairBlock(Vanilla_PlusBlocks.STRIPPED_ACACIA_LOG::defaultBlockState, (BlockBehaviour.Properties.copy(Vanilla_PlusBlocks.STRIPPED_ACACIA_LOG))));
        registry.register("stripped_dark_oak_log_stairs", () -> new StairBlock(Vanilla_PlusBlocks.STRIPPED_DARK_OAK_LOG::defaultBlockState, (BlockBehaviour.Properties.copy(Vanilla_PlusBlocks.STRIPPED_DARK_OAK_LOG))));
        registry.register("stripped_crimson_stem_stairs", () -> new StairBlock(Vanilla_PlusBlocks.STRIPPED_CRIMSON_STEM::defaultBlockState, (BlockBehaviour.Properties.copy(Vanilla_PlusBlocks.STRIPPED_CRIMSON_STEM))));
        registry.register("stripped_warped_stem_stairs", () -> new StairBlock(Vanilla_PlusBlocks.STRIPPED_WARPED_STEM::defaultBlockState, (BlockBehaviour.Properties.copy(Vanilla_PlusBlocks.STRIPPED_WARPED_STEM))));
        ...
        registry.register("quartz_pillar_stairs", () -> new StairBlock(Vanilla_PlusBlocks.QUARTZ_PILLAR::defaultBlockState, (BlockBehaviour.Properties.copy(Vanilla_PlusBlocks.QUARTZ_PILLAR))));
        registry.register("hay_bale_stairs", () -> new StairBlock(Vanilla_PlusBlocks.HAY_BLOCK::defaultBlockState, (BlockBehaviour.Properties.copy(Vanilla_PlusBlocks.HAY_BLOCK))));
        ...
        registry.register("white_stained_glass_stairs", () -> new StairBlock(Blocks.WHITE_STAINED_GLASS::defaultBlockState, (BlockBehaviour.Properties.copy(Blocks.WHITE_STAINED_GLASS))));
        registry.register("orange_stained_glass_stairs", () -> new StairBlock(Blocks.ORANGE_STAINED_GLASS::defaultBlockState, (BlockBehaviour.Properties.copy(Blocks.ORANGE_STAINED_GLASS))));
        registry.register("magenta_stained_glass_stairs", () -> new StairBlock(Blocks.MAGENTA_STAINED_GLASS::defaultBlockState, (BlockBehaviour.Properties.copy(Blocks.MAGENTA_STAINED_GLASS))));
        registry.register("light_blue_stained_glass_stairs", () -> new StairBlock(Blocks.LIGHT_BLUE_STAINED_GLASS::defaultBlockState, (BlockBehaviour.Properties.copy(Blocks.LIGHT_BLUE_STAINED_GLASS))));
        registry.register("yellow_stained_glass_stairs", () -> new StairBlock(Blocks.YELLOW_STAINED_GLASS::defaultBlockState, (BlockBehaviour.Properties.copy(Blocks.YELLOW_STAINED_GLASS))));
        registry.register("lime_stained_glass_stairs", () -> new StairBlock(Blocks.LIME_STAINED_GLASS::defaultBlockState, (BlockBehaviour.Properties.copy(Blocks.LIME_STAINED_GLASS))));
        registry.register("pink_stained_glass_stairs", () -> new StairBlock(Blocks.PINK_STAINED_GLASS::defaultBlockState, (BlockBehaviour.Properties.copy(Blocks.PINK_STAINED_GLASS))));
        registry.register("gray_stained_glass_stairs", () -> new StairBlock(Blocks.GRAY_STAINED_GLASS::defaultBlockState, (BlockBehaviour.Properties.copy(Blocks.GRAY_STAINED_GLASS))));
        registry.register("light_gray_stained_glass_stairs", () -> new StairBlock(Blocks.LIGHT_GRAY_STAINED_GLASS::defaultBlockState, (BlockBehaviour.Properties.copy(Blocks.LIGHT_GRAY_STAINED_GLASS))));
        registry.register("cyan_stained_glass_stairs", () -> new StairBlock(Blocks.CYAN_STAINED_GLASS::defaultBlockState, (BlockBehaviour.Properties.copy(Blocks.CYAN_STAINED_GLASS))));
        registry.register("purple_stained_glass_stairs", () -> new StairBlock(Blocks.PURPLE_STAINED_GLASS::defaultBlockState, (BlockBehaviour.Properties.copy(Blocks.PURPLE_STAINED_GLASS))));
        registry.register("blue_stained_glass_stairs", () -> new StairBlock(Blocks.BLUE_STAINED_GLASS::defaultBlockState, (BlockBehaviour.Properties.copy(Blocks.BLUE_STAINED_GLASS))));
        registry.register("brown_stained_glass_stairs", () -> new StairBlock(Blocks.BROWN_STAINED_GLASS::defaultBlockState, (BlockBehaviour.Properties.copy(Blocks.BROWN_STAINED_GLASS))));
        registry.register("green_stained_glass_stairs", () -> new StairBlock(Blocks.GREEN_STAINED_GLASS::defaultBlockState, (BlockBehaviour.Properties.copy(Blocks.GREEN_STAINED_GLASS))));
        registry.register("red_stained_glass_stairs", () -> new StairBlock(Blocks.RED_STAINED_GLASS::defaultBlockState, (BlockBehaviour.Properties.copy(Blocks.RED_STAINED_GLASS))));
        registry.register("black_stained_glass_stairs", () -> new StairBlock(Blocks.BLACK_STAINED_GLASS::defaultBlockState, (BlockBehaviour.Properties.copy(Blocks.BLACK_STAINED_GLASS))));
        ...
        registry.register("oak_log_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Vanilla_PlusBlocks.OAK_LOG)));
        registry.register("spruce_log_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Vanilla_PlusBlocks.SPRUCE_LOG)));
        registry.register("birch_log_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Vanilla_PlusBlocks.BIRCH_LOG)));
        registry.register("jungle_log_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Vanilla_PlusBlocks.JUNGLE_LOG)));
        registry.register("acacia_log_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Vanilla_PlusBlocks.ACACIA_LOG)));
        registry.register("dark_oak_log_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Vanilla_PlusBlocks.DARK_OAK_LOG)));
        registry.register("crimson_stem_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Vanilla_PlusBlocks.CRIMSON_STEM)));
        registry.register("warped_stem_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Vanilla_PlusBlocks.WARPED_STEM)));
        registry.register("stripped_oak_log_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Vanilla_PlusBlocks.STRIPPED_OAK_LOG)));
        registry.register("stripped_spruce_log_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Vanilla_PlusBlocks.STRIPPED_SPRUCE_LOG)));
        registry.register("stripped_birch_log_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Vanilla_PlusBlocks.STRIPPED_BIRCH_LOG)));
        registry.register("stripped_jungle_log_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Vanilla_PlusBlocks.STRIPPED_JUNGLE_LOG)));
        registry.register("stripped_acacia_log_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Vanilla_PlusBlocks.STRIPPED_ACACIA_LOG)));
        registry.register("stripped_dark_oak_log_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Vanilla_PlusBlocks.STRIPPED_DARK_OAK_LOG)));
        registry.register("stripped_crimson_stem_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Vanilla_PlusBlocks.STRIPPED_CRIMSON_STEM)));
        registry.register("stripped_warped_stem_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Vanilla_PlusBlocks.STRIPPED_WARPED_STEM)));
        ...
        registry.register("purpur_pillar_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Vanilla_PlusBlocks.PURPUR_PILLAR)));
        ...
        registry.register("quartz_pillar_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Vanilla_PlusBlocks.QUARTZ_PILLAR)));
        registry.register("hay_bale_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Vanilla_PlusBlocks.HAY_BLOCK)));
        ...
        registry.register("white_stained_glass_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Blocks.WHITE_STAINED_GLASS)));
        registry.register("orange_stained_glass_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Blocks.ORANGE_STAINED_GLASS)));
        registry.register("magenta_stained_glass_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Blocks.MAGENTA_STAINED_GLASS)));
        registry.register("light_blue_stained_glass_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Blocks.LIGHT_BLUE_STAINED_GLASS)));
        registry.register("yellow_stained_glass_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Blocks.YELLOW_STAINED_GLASS)));
        registry.register("lime_stained_glass_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Blocks.LIME_STAINED_GLASS)));
        registry.register("pink_stained_glass_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Blocks.PINK_STAINED_GLASS)));
        registry.register("gray_stained_glass_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Blocks.GRAY_STAINED_GLASS)));
        registry.register("light_gray_stained_glass_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Blocks.LIGHT_GRAY_STAINED_GLASS)));
        registry.register("cyan_stained_glass_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Blocks.CYAN_STAINED_GLASS)));
        registry.register("purple_stained_glass_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Blocks.PURPLE_STAINED_GLASS)));
        registry.register("blue_stained_glass_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Blocks.BLUE_STAINED_GLASS)));
        registry.register("brown_stained_glass_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Blocks.BROWN_STAINED_GLASS)));
        registry.register("green_stained_glass_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Blocks.GREEN_STAINED_GLASS)));
        registry.register("red_stained_glass_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Blocks.RED_STAINED_GLASS)));
        registry.register("black_stained_glass_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Blocks.BLACK_STAINED_GLASS)));
